var InputIterationBuilder = function(model, diagram) {
...
var RowIterator = function(element, rowToAdd, previousKey){
    ...
    for(var y = 0; y < 3; y++){
        ...
        if(y == 0){
            ...
            newText.id = previousKey == "" || previousKey == null ? "width" + (rowToAdd.key) : "frontOffset" + (rowToAdd.key);
            newText.value = previousKey == "" || previousKey == null || previousKey == null ? rowToAdd.width * 20 : rowToAdd.frontOffset * 20;
        }
        else {
            newText = document.createElement("input");
            newText.id = previousKey == "" || previousKey == null ? "height" + (rowToAdd.key) : "backOffset" + (rowToAdd.key);
            newText.value = previousKey == "" || previousKey == null ? rowToAdd.height * 20 : rowToAdd.backOffset * 20;
            newText.readOnly = newText.id.indexOf("backOffset") > -1 ? true : false;
        }
