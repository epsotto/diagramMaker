...
var DimensionBuilder = function (JsonModel){
  ...
  for (var i = 1; i < JsonModel.nodeDataArray.length; i++){
    ...
    var yPosition = parseInt(JsonModel.nodeDataArray[i].loc.split(" ")[1]);
    ...
    if(heightDifference < 0 || yPosition > 0){
       ...
       result.push(linkDataArray);
       setBackOffset = document.getElementById("backOffset"+JsonModel.nodeDataArray[i].key);
       if(setBackOffset != null && yPosition != 0){
        computedBottomDimension = (yPosition + parseInt(JsonModel.nodeDataArray[i].height)) - parseInt(JsonModel.nodeDataArray[i-1].height);
        setBackOffset.value = Math.abs(computedBottomDimension)*20;
       }
       else if(setBackOffset != null && yPosition == 0){
        setBackOffset.value = Math.abs(heightDifference)*20;
       }
      ...
      linkDataArray.from = JsonModel.nodeDataArray[i-1].key;
       ...
       result.push(linkDataArray);
       var BackOffset = document.getElementById("backOffset"+JsonModel.nodeDataArray[i].key);
       if(setBackOffset != null && yPosition != 0){
        var computedBottomDimension = (yPosition + parseInt(JsonModel.nodeDataArray[i].height)) - parseInt(JsonModel.nodeDataArray[i-1].height);
        setBackOffset.value = Math.abs(computedBottomDimension)*20;
       }
       else if (setBackOffset != null && yPosition == 0){
        setBackOffset.value = Math.abs(heightDifference)*20;
